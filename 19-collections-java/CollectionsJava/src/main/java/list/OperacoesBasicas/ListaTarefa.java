...
public class ListaTarefa {
  ...
  public void removerTarefa(String descricao) {
    ...
    if (!tarefaList.isEmpty()) {
      for (Tarefa t : tarefaList) {//forEach utilizado para o caso de querer pegar todos os elementos repetidos
        if (t.getDescricao().equalsIgnoreCase(descricao)) {
          tarefasParaRemover.add(t);
        }
      }
      tarefaList.removeAll(tarefasParaRemover);//irá remover todos os elementos repetidos
    } else {
  ...
  public static void main(String[] args) {
    ...
    listaTarefa.adicionarTarefa("Pagar aluguel");
